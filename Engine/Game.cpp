	...
	if (gameIsStarted)
	{
		if (!gameIsOver)
		{
			...
			if (snekMoveCounter >= snekMovePeriod)
			{
				...
				{
					//original manual key-press to control snek growth
					/*
...
void Game::ComposeFrame()
{
	if (gameIsStarted)
	{
		...
		if (gameIsOver)
		{
			SpriteCodex::DrawGameOver(350, 365, gfx);
		}
		brd.DrawBorder();
	}
	else
	...
	// Chili did this within ComposeFrame in 14a then called it "test code" in 14b
	/*
